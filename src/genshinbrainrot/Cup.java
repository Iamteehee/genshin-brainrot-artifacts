...
public class Cup {
    ...
    public Cup(double attributeDmg, double attackPercent, double HPPercent, double critRate, double critDamage, double energyRecharge, double defPercent, int flatAttack, int flatHP, int elementalMastery, int flatDef) {
    ...
    public void printCupInfo() {
        System.out.println("Your cup's stats are as follows: ");
