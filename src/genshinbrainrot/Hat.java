...
public class Hat {
    ...
    public Hat(double attributeDmg, double attackPercent, double HPPercent, double critRate, double critDamage, double energyRecharge, double defPercent, int flatAttack, int flatHP, int elementalMastery, int flatDef) {
    ...
    public void printHatInfo() {
        System.out.println("Your hat's stats are as follows: ");
