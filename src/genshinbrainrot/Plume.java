...
public class Plume {
    ...
    public Plume(double attributeDmg, double attackPercent, double HPPercent, double critRate, double critDamage, double energyRecharge, double defPercent, int flatAttack, int flatHP, int elementalMastery, int flatDef) {
    ...
    public void printPlumeInfo() {
        System.out.println("Your plume's stats are as follows: ");
