...
public class Sand {
    ...
    public Sand(double attributeDmg, double attackPercent, double HPPercent, double critRate, double critDamage, double energyRecharge, double defPercent, int flatAttack, int flatHP, int elementalMastery, int flatDef) {
    ...
    public void printSandInfo() {
        System.out.println("Your sand's stats are as follows: ");
